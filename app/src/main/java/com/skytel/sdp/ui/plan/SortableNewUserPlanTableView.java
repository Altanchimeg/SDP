...
import com.skytel.sdp.ui.newnumber.NewNumberReportComparator;
...
public class SortableNewUserPlanTableView extends SortableTableView<Plan> {
    public SortableNewUserPlanTableView(Context context) {
        this(context, null);
    }

    public SortableNewUserPlanTableView(Context context, AttributeSet attributes) {
        this(context, attributes, android.R.attr.listViewStyle);
    }

    public SortableNewUserPlanTableView(Context context, AttributeSet attributes, int styleAttributes) {
